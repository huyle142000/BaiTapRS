...
class Bill extends Component {
  renderBill() {
    ...
    return danhSachGheDaDat.map((item, i) => {
      return (
        <tr key={i} className="billBody">
          ...
          <td>
            <button
              ...
              onClick={() => {
                this.props.handleDelete(item.value);
              }}
            >
              X
            </button>
  ...
  render() {
    ...
    return (
      <div style={{ marginTop: "40px" }}>
        ...
        <p>
          <span className="bgChair1 bgChair"></span> Ghế đã đặt
        </p>
        <p>
          <span className="bgChair2 bgChair"></span>Ghế đang chọn
        </p>
        <p>
          <span className="bgChair3 bgChair"></span>Ghế chưa đặt
        </p>
        <table className="tadivble">
          ...
          {bill.length === 0 ? (
            ...
            <tfoot>
              <tr>
                <td style={{ fontSize: "20px" }}>Thành tiền :</td>
